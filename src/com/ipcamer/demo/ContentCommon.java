...
public class ContentCommon {
	...
	//常量类
	public static final String STR_CAMERA_INFO_RECEIVER = "object.ipcam.client.camerainforeceiver";//接受者
	public static final String STR_CAMERA_ADDR = "camera_addr"; //地址
	public static final String STR_CAMERA_PORT = "camera_port";//端口
	public static final String STR_CAMERA_NAME = "camera_name";
	public static final String STR_CAMERA_MAC = "camera_mac";//mac地址
	...
	public static final String STR_CAMERA_SNAPSHOT = "camera_snapshot";//快照
	public static final String STR_CAMERA_USER_AUTHORITY = "camera_user_authority";//权限
	...
	public static final String CAMERA_OPTION = "camera_option";//选项
	public static final int ADD_CAMERA = 1;
	public static final int EDIT_CAMERA = 2;//编辑
	public static final int CHANGE_CAMERA_USER = 3;
	public static final int DEL_CAMERA = 4;
	public static final int INVALID_OPTION = 0xffff;//无效选项
